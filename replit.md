...
**Gradient Background Grade Badges (July 17, 2025):** Updated Bet Bot pick grade badges in game cards to use custom gradient background image with enhanced rounded corners (rounded-xl). The gradient combines orange and blue tones for a premium visual effect while maintaining white text with drop-shadow for optimal readability. This styling applies only to the game card grade bubbles, not the top Pick of the Day and Lock Pick sections as requested.
