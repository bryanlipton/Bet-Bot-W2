...
**Affiliate System Setup (July 17, 2025):** Implemented production-ready affiliate link system with automatic fallback to login/signup pages. Currently uses dummy affiliate codes (`betbot123`) but is configured to automatically switch to real affiliate links when provided through environment variables. System supports both standard affiliate linking and deep linking with bet slip integration for 6 major sportsbooks. Complete documentation provided for easy transition to production affiliate codes.
