export default async function handler(req, res) {
  ...
  try {
    ...
    const endpoints = [
      ...
      `https://sports.core.api.espn.com/v2/sports/football/leagues/college-football/events/${cleanGameId}/competitions/${cleanGameId}`
    ];
    ...
    return res.status(200).json({
      ...
      down: downDistance, // Will be null if no data
      possession: possession, // Will be null if no data
      yardLine: yardLine, // Will be null if no data
