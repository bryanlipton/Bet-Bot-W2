                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">Advanced machine learning models analyze 27+ factors including weather, ballpark conditions, and team performance.</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
