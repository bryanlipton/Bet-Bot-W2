                  ...
                  <section>
                    ...
                    <ol className="space-y-2 text-gray-700 dark:text-gray-300">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Our AI processes real-time data from official MLB, NBA, NHL, NFL, and NCAA sources, along with weather patterns and historical performance metrics, to deliver accurate insights.</span>
                      </li>
                      <li className="flex items-start gap-2">
